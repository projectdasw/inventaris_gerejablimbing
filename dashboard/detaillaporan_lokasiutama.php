<?php
    ...
    $query = "select count(*) as total from barang_gereja where nama_lokasi_utama='$nm_loc'";
    $sql = mysqli_query($connect, $query);
    $countdata = mysqli_fetch_assoc($sql);

    $query2 = "select sum(jumlah) as total from barang_gereja where nama_lokasi_utama='$nm_loc'";
...
<div class='d-flex flex-row justify-content-between align-items-center'>
    <div class="row">
        <span>
            Total inventaris <?php echo $nm_loc; ?> : <?php echo $countdata['total'];?>
        </span>
        <span>
            Total Jumlah barang <?php echo $nm_loc; ?> : <?php echo $countdata2['total'];?>
        </span>
    </div>
    <div>
    ...
    <table class="display table table-hover">
        ...
        <tbody>
            <?php
                ...
                $tampil_barang_gereja = "select * from barang_gereja where nama_lokasi_utama='$nm_loc'";

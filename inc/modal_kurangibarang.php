<div class="modal fade" id="kurangi_barang" tabindex="-1" aria-labelledby="modal_kurangibarang" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modal_kurangibarang">
                    Pengurangan Barang
                </h1>
